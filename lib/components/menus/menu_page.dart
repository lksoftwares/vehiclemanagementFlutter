...
//               });
//               print("Selected Parent Menu ID: $_selectedParentMenuId");
//             },
//             decoration: InputDecoration(
//               border: OutlineInputBorder(),
//               labelText: 'Select Parent Menu',
//             ),
//             items: _allMenus.map<DropdownMenuItem<String>>((menu) {
...
//
//             if (menuId == null) {
//               if (menuName.isEmpty || _selectedImage == null || _selectedParentMenuId == null) {
//                 ScaffoldMessenger.of(context).showSnackBar(
...
//
//             if (menuId == null) {
//               if (menuName.isEmpty || _selectedParentMenuId == null) {
//                 ScaffoldMessenger.of(context).showSnackBar(
//                   SnackBar(content: Text('Please fill all fields')),
//                 );
//                 return;
